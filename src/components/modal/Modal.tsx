...
interface ModalProps {
  type: string;
  updateFilterOptions?: (searchTerm: string) => void;
        ...
        <div className="help-modal-wrapper">
          <div className="help-content">
            ...
            <p className="help-text">
              To add an item to your tracking list, simply locate the item on
              the screen. Click on the "Track" button associated with the item.
            </p>
            <span className="help-title">Viewing Tracked Items:</span>
            <p className="help-text">
              Once an item is tracked, you can view it on the tracking list
              located on the side of the screen.
            </p>
            <p className="help-text">
              Click on the tracking list button to expand and see detailed
              information about each tracked item.
            </p>
            <span className="help-title">Collecting an Item:</span>
            <p className="help-text">
              When you want to mark an item as collected, find the item on the
              tracking list and click on the Collect button associated with the
              item. The item will now be marked as collected, providing a visual
              indicator of your progress.
            </p>
            <span className="help-title">Additional Features:</span>
            <p className="help-text">
              Customize your tracking list by applying filters.
            </p>
            <p className="help-text">
              Use the search function to quickly find specific items to add to
              your list.
            </p>
            <span className="help-title">Troubleshooting:</span>
            <p className="help-text">
              Should you encounter any issues, check the Github page.
            </p>
            <p className="help-text">
              If any information is incorrect or missing then visit the Wiki:
            </p>
            <a
              className="help-link"
              target="_blank"
          ...
          {Object.keys(typeList).map((category) => (
            <div className="filter-content">
              <div
                ...
                onClick={() => updateCollapsed(category)}
              >
